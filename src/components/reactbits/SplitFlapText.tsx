  ...
  return (
    <>
      ...
      <div
        ...
        /* Upstream ships `role="text"`, which is not a real ARIA role: it is
           discarded along with the label, leaving a screen reader to announce
           the tiles one character at a time. `img` with a label is the honest
           description of what this is — a picture of a word. */
        role="img"
