...
- [x] Every unbuilt Area names three or four things that will live there
- [x] Every pointer offered is real and reachable today
- [x] An Area with nowhere to point offers nothing rather than inventing one
- [x] Still one component, and still no illustration, count or progress bar
- [x] The screen no longer ends in a third of a viewport of Ground
